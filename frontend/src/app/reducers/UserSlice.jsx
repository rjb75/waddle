...
export const userSlice = createSlice({
  ...
  reducers: {
    setUser: (state, action) => {
      // Sets the user, takes payload of nickname as String and the email as a String
      state.nickname = action.payload.userName;
      state.email = action.payload.email;
    },
    setNickname: (state, action) => {
      // Sets the nickname, takes the payload of nickname as a String
      state.nickname = action.payload;
    },
    setEmail: (state, action) => {
      // Sets the email, takes the payload of email as a String
...
export const { setUser, setNickname, setEmail, setUID } = userSlice.actions;
